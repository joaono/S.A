...
function Cadastrar(){
    ...
    let cont = 0
        ...
        usuarioSupremo.usernameAdm = jobson
        usuarioSupremo.passwordAdm = 123

        vetorUsers = JSON.parse(localStorage.getItem('usuarioSalvo'))
        adm = JSON.parse(localStorage.getItem('usuarioSupremoSalvo'))
...
function cadastro(){
    ...
    if(cadastroMeio.style.display === 'nome'){
